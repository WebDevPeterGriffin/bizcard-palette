...
interface PreviewCardClientProps {
    styleId: string;
}

const PreviewCardClient = ({ styleId }: PreviewCardClientProps) => {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Button onClick={() => router.push('/styles')}>Back to Styles</Button>
                </div>
            </div>
        );
    }
            ...
            <div className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        <Button variant="ghost" onClick={() => router.push('/styles')}>
                            <ArrowLeft className="mr-2 h-4 w-4" />
                            Back to Styles
                        </Button>
                        <h1 className="text-xl font-semibold">{meta.name} Preview</h1>
                        <Button onClick={() => router.push(`/request?style=${styleId}`)}>
                            Choose This Style
                        </Button>
                    </div>
                </div>
...
export default PreviewCardClient;
