    ...
    <Card className="relative w-80 h-auto min-h-[26rem] overflow-hidden border border-white/10 bg-gradient-to-b from-[#0b0b10] via-[#12121a] to-[#0b0b10] backdrop-blur-md mx-auto">
      ...
      <div className="relative z-10 p-6 text-white">
        <ProfileSection
          ...
          headshotClassName="mx-auto mb-4 h-32 w-32 md:h-36 md:w-36 rounded-full border-4 border-white/20 overflow-hidden shadow-2xl shadow-purple-500/30 object-cover"
...
export default React.memo(PrismCard);
